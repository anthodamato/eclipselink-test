package com.test.hibernate.fails;
...
import com.test.eclipselink.model.Holiday;
...
public class HolidayTest2 {
	...
	public void gtCriteria() {
		...
		try {
			...
			h1r = em.find(Holiday.class, h1.getId());
			Assertions.assertNotNull(h1r);
			Assertions.assertEquals(h1.getCheckIn(), h1r.getCheckIn());
			h1 = h1r;
