...
import com.test.eclipselink.model.Artist;
import com.test.eclipselink.model.Movie;
import com.test.eclipselink.model.Song;
...
public class MultipleJoinTest {
    private Logger log = Logger.getLogger(MultipleJoinTest.class);
