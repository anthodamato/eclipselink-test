...
import com.test.eclipselink.model.SearchData;
...
public class SearchDataTest {
    ...
    public void criteriaSumProdDiff() throws Exception {
        ...
        Assertions.assertEquals(8, resultList.get(1));
        tx.commit();
    ...
    private void testSum2(EntityManager em) {
        ...
        Assertions.assertEquals(8.0f, resultList.get(1));
    }
    ...
    private void testOr(EntityManager em) {
        ...
        List<Number> resultList = typedQuery.getResultList();
        Assertions.assertEquals(2, resultList.size());
        Assertions.assertEquals(8.0f, resultList.get(0));
        Assertions.assertEquals(7.0f, resultList.get(1));
    }
    ...
    private void testProd1(EntityManager em) {
        ...
        Assertions.assertEquals(25, resultList.get(0));
    }
    ...
    private void testProd3(EntityManager em) {
        ...
        List<BigDecimal> resultList = typedQuery.getResultList();
        Assertions.assertEquals(1, resultList.size());
        Assertions.assertEquals(BigDecimal.valueOf(10), resultList.get(0));
    }
    ...
    private void testQuot2(EntityManager em) {
        ...
        List<Number> resultList = typedQuery.getResultList();
        Assertions.assertEquals(1, resultList.size());
        Assertions.assertEquals(4.8f, resultList.get(0));
    }
    ...
    private void testQuot3(EntityManager em) {
        ...
        List<Number> resultList = typedQuery.getResultList();
        Assertions.assertEquals(1, resultList.size());
        // should return 5.2f but return 5 (Integer)
        Assertions.assertEquals(Integer.valueOf(5), resultList.get(0));
    }
    ...
    private void testToBigDecimal(EntityManager em) {
        ...
        List<BigDecimal> resultList = typedQuery.getResultList();
        Assertions.assertEquals(1, resultList.size());
        // should return BigDecimal but returns Integer
        Assertions.assertEquals(Integer.valueOf(120), resultList.get(0));
    }
    ...
    private void testToBigInteger(EntityManager em) {
        ...
        List<BigInteger> resultList = typedQuery.getResultList();
        Assertions.assertEquals(1, resultList.size());
        // should return BigInteger but returns Integer
        Assertions.assertEquals(Integer.valueOf(120), resultList.get(0));
    }
    ...
    private void testToDouble(EntityManager em) {
        ...
        Assertions.assertEquals(1, resultList.size());
        // should return Double but returns Integer
        Assertions.assertEquals(Integer.valueOf(120), resultList.get(0));
    }
    ...
    private void testToFloat(EntityManager em) {
        ...
        List<Float> resultList = typedQuery.getResultList();
        Assertions.assertEquals(1, resultList.size());
        // should return Float but returns Integer
        Assertions.assertEquals(Integer.valueOf(120), resultList.get(0));
    }
    ...
    private void testToLong(EntityManager em) {
        ...
        Assertions.assertEquals(1, resultList.size());
        // should return Long but returns Integer
        Assertions.assertEquals(Integer.valueOf(120), resultList.get(0));
    }
